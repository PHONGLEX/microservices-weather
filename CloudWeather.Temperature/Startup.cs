...
namespace CloudWeather.Temperature
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TemperatureDbContext>(opts =>
            {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CloudWeather.Temperature", Version = "v1" });
            });
        }
